    ...
    <main className="min-h-screen">
        ...
        <div className="container px-4 mx-auto">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <motion.div
              ...
              className="z-10"
            >
              <motion.h1 variants={itemVariants} className="text-5xl md:text-7xl font-serif font-bold mb-6">
                The Art of <span className="text-gold">Classical Dance</span>
              </motion.h1>

              <motion.p variants={itemVariants} className="text-lg md:text-xl mb-8">
                Expressing emotions through movement, rhythm, and storytelling in the ancient tradition of classical
                dance.
              </motion.p>
        ...
        <div className="container px-4 mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                With over 15 years of training in classical dance forms, I bring stories to life through movement and
                expression. My performances blend traditional techniques with contemporary interpretations, creating a
              ...
              <motion.p
                ...
                className="text-muted-foreground"
              >
                I have performed at prestigious venues across the country and internationally, sharing the rich cultural
                heritage of classical dance with diverse audiences.
              </motion.p>
      ...
      <section className="py-20 bg-muted">
        <div className="container px-4 mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">Featured Performances</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Highlights from recent performances and upcoming events. Experience the beauty and grace of classical
              dance.
            </p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-8">
            {["assets/classical/006.JPG", "assets/classical/018.jpg","assets/classical/003.jpg"].map((item, index) => (
              <motion.div
                key={item}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center text-muted-foreground mb-3">
                      ...
                      <span className="text-sm">
                        {index === 0 ? "June 15, 2023" : index === 1 ? "August 22, 2023" : "October 5, 2023"}
                      </span>
                    </div>
      ...
      <section className="py-20 bg-muted">
        <div className="container px-4 mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Celebrating achievements and honors received for contributions to classical dance.
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="container px-4 mx-auto">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">Gallery Highlights</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Capturing moments of grace, expression, and movement from performances around the world.
            </p>
          </motion.div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {["assets/classical/016.jpg", "assets/classical/019.jpg","assets/classical/013.jpg","assets/classical/023.jpg"].map((item, index) => (
              <motion.div
                key={item}
          ...
          >
            ...
            <div className="relative z-10">
              <motion.div
                ...
                className="max-w-2xl"
              >
                <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">Ready to Experience Classical Dance?</h2>
                <p className="text-muted-foreground mb-8">
                  Whether you&apos;re interested in booking a performance, attending a workshop, or simply want to learn more
                  about classical dance, I&apos;d love to hear from you.
                </p>
