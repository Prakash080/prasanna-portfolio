        ...
        <div className="container px-4 mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Request a performance or workshop for your event, festival, or
                  ...
                  {isSuccess ? (
                    ...
                    >
                      ...
                      <p>
                        ...
                        48 hours to discuss details and availability.
                      </p>
                    </motion.div>
                  ) : (
            ...
            >
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Bookings are typically confirmed 2-3 months in
                          advance. For urgent requests, please contact directly.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Fees vary based on event type, duration, location, and
                          technical requirements. A detailed quote will be
                          provided after reviewing your request.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Available for performances nationwide and
                          internationally. Travel and accommodation arrangements
                          to be discussed.
                        </p>
                      </div>
                    </div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start space-x-2">
                      ...
                      <span className="text-sm">
                        Solo Classical Dance Recitals (60-90 minutes)
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-primary mt-2" />
                      <span className="text-sm">
                        Thematic Performances (45-60 minutes)
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-primary mt-2" />
                      <span className="text-sm">
                        Lecture Demonstrations (90-120 minutes)
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-primary mt-2" />
                      <span className="text-sm">
                        Workshops for Beginners to Advanced (2-3 hours)
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-primary mt-2" />
                      <span className="text-sm">
                        Masterclasses for Dance Students (3-4 hours)
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-primary mt-2" />
                      <span className="text-sm">
                        Cultural Events and Festival Performances
                      </span>
                    </li>
                  </ul>
                </CardContent>
              ...
              <div className="bg-muted p-6 rounded-lg">
                ...
                <p className="text-muted-foreground mb-4">
                  If you have questions about booking a performance or workshop,
                  please don&apos;t hesitate to contact directly.
                </p>
                <div className="flex items-center space-x-2">
